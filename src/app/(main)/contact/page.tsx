  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.formMapSection}>
        <ScrollReveal animation="slide-right" className={styles.formContainer}>
          <form>
        ...
        <ScrollReveal animation="slide-left" className={styles.mapContainer}>
          <iframe
      ...
      <section className={styles.infoBoxesSection}>
        <div className={styles.infoBoxesGrid}>
          <ScrollReveal animation="fade-up" delay={0} className={styles.infoBox}>
          ...
          <ScrollReveal animation="fade-up" delay={100} className={styles.infoBox}>
            <div className={styles.iconWrapper}>
          ...
          <ScrollReveal animation="fade-up" delay={200} className={styles.infoBox}>
            <div className={styles.iconWrapper}>
          ...
          <ScrollReveal animation="fade-up" delay={300} className={styles.infoBox}>
            <div className={styles.iconWrapper}>
      ...
      <section className={styles.faqSection}>
        <ScrollReveal animation="fade-up" className={styles.faqContent}>
