                  ...
                  <td className="py-6 align-top">
                    <div className="flex items-start gap-5 pr-4">
                      ...
                      <div className="pt-1 flex flex-col">
                        {item.productSlug ? (
                          <Link href={`/products/${encodeURIComponent(item.productSlug)}`} className="text-base font-semibold text-[#001f3f] hover:text-[#d4af37] transition-colors line-clamp-2 uppercase">
                            {item.productName}
                          </Link>
                        ) : (
                          <span className="text-base font-semibold text-[#001f3f] line-clamp-2 uppercase">
                            {item.productName}
                          </span>
                        )}
                        {item.variationLabel && (
