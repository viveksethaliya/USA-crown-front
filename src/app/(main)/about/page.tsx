        ...
        <main className={styles.main}>
            ...
            <section className={styles.whoWeAreSection}>
                ...
                <div className={styles.whoWeAreContent}>
                    ...
                    <ScrollReveal animation="slide-left" className={styles.whoWeAreText}>
                        <p>
            ...
            <section className={styles.commitmentSection}>
                <div className={styles.commitmentContent}>
                    <ScrollReveal animation="slide-right" className={styles.commitmentText}>
                    ...
                    <div className={styles.commitmentStats}>
                        <ScrollReveal animation="fade-up" delay={0} className={styles.statCard}>
                            <h3>43+</h3>
                            <span>Years In Business</span>
                        </ScrollReveal>

                        <ScrollReveal animation="fade-up" delay={200} className={styles.statCard}>
                            <h3>5,000+</h3>
                            <span>Loyal Customers</span>
                        </ScrollReveal>

                        <ScrollReveal animation="fade-up" delay={400} className={styles.statCard}>
                            <h3>24/7</h3>
